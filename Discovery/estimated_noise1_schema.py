...
CANDIDATE = {'class_id': str, 'expanded': mapping(str), 'members': seq(mapping(str)),
             'representative': mapping(str), 'log_coefficient': NUM, 'coefficient': POS,
...
DISCOVERY = {'input_sha256': HASH, 'evidence_class': str, 'ranking': seq(CANDIDATE),
    'top_class': optional(str), 'decision': str, 'equivalence_map': mapping(seq(mapping(str))),
