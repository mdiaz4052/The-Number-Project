...
SOURCE_PATHS = tuple('Discovery/'+n+'.py' for n in (
    ...
    'estimated_noise1_verifier', 'estimated_noise1_preflight', 'symbolic_suite_runner', 'symbolic_suite_engine',
...
def failure(stage, exc):
    ...
    record = {'stage': stage, 'source_sha': git('rev-parse', 'HEAD'), 'observed_utc': now(),
